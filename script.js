...
function clearAll() {
    ...
    for (let i = 0; i < parent.children.length; i++){
      let tagName = parent.children.item(i).tagName;
  ...
  */
  function showMeme() {
    ...
    // selecting the element to insert before 
    const pelem = document.querySelectorAll('h3').item(1);
    ...
    randomMeme.src = randomMemeUrl;
    
    // inserting the element in the document
    parent.insertBefore(randomMeme,pelem);
  }
  ...
  */
  function showJoke() {
    ...
    // selecting the element to insert before 
    const pelem = document.querySelectorAll('h3').item(2);
    ...
    // inserting the element in the document
    parent.insertBefore(randomJoke,pelem);
  }
  ...
  */
  function showQuote() {
    ...
    //creating a string that is to be displayed
    const string = randomQuote.quote + "\n-" + randomQuote.author;
    
    // selecting the element to insert before 
    const pelem = document.querySelectorAll('h3').item(3);
    ...
    // inserting the element in the document
    parent.insertBefore(quote,pelem);
  }
  ...
  */
  function showRiddle() {
    ...
    const answer = "answer: "+randomRiddle.answer;
    
    // creating an element to display the riddle and one for the answer
    const randomQuestion = document.createElement('p');
    randomQuestion.textContent = question;
    const randomAnswer = document.createElement('p');
    randomAnswer.textContent = answer;
    
    // creating the parent element
    const parent = document.querySelector(".content");
    
    // using the append child method to add the element to the end of the list
    parent.appendChild(randomQuestion);
    
    // append the answer as well and hide it
    // it will be later revealed when revealAnswers() method is invoked
    randomAnswer.style.visibility = "hidden";
    parent.appendChild(randomAnswer);
  }
  ...
  */
  function revealAnswers() {
    ...
    const parent = document.querySelector(".content");
    const allpTags = parent.querySelectorAll("p");
    const targetElement = allpTags.item(allpTags.length-1);
